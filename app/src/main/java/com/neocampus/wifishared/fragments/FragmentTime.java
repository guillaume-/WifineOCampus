...
public class FragmentTime extends Fragment implements OnFragmentConfigListener, CompoundButton.OnCheckedChangeListener {
    ...
    /**
     * RécupÃ¨re le seuil initial du temps d'activation
     *
    ...
    /**
     * Modifier le code de notification, en cas d'activation ou de déssactivation de la notification pour le temps
     * @param buttonView Vue sur laquelle l'utilisateur a cliqué
     * @param isChecked Indique si la notification est activée ou pas
     */
    @Override
